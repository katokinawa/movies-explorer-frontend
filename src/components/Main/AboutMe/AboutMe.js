  ...
  return (
    <section className="aboutme">
      ...
      <div className="aboutme__text-wrapper">
        ...
        <h3 className="title aboutme__title">Виталий</h3>
        ...
        <p className="subtitle aboutme__subtitle">
          ...
          лень и вообще, хватит читать, переходите <a href="https://music.yandex.ru/album/16029794/track/84516454">по ссылке.</a>
        </p>
      </div>
      <a
