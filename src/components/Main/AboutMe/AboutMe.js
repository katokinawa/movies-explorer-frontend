    ...
    <section className="aboutme">
      ...
      <div className="aboutme__text-wrapper">
        ...
        <p className="subtitle aboutme__subtitle">
            ...
            Я люблю читать книги, с особым трудом давались научные, но после я понял, что ничего сложного в этом нет, а самое главное, что мне это нравится. Изучать и быть на шаг впереди, не давая мозгу расслабиться, вот моё правило.
            После окончания курса планирую найти работу свяазанную с веб-разработкой.
        </p>
      </div>
      <a
